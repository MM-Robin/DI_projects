...
vlib work && vcom '-2019' '-o' design.vhd testbench.vhd  && vsim -c -do "vsim NBITADDER_TB; run -all; exit"  ; echo 'Creating result.zip...' && zip -r /tmp/tmp_zip_file_123play.zip . && mv /tmp/tmp_zip_file_123play.zip result.zip